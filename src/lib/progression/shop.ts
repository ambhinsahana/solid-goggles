...
export const SYSTEM_SHOP_ITEMS: ShopItem[] = [
  ...
  {
    id: 'skin_spriggo_autumn',
    name: 'Autumn Spriggo',
    description: 'Warm golden amber foliage skin for your Spriggo companion.',
    type: 'companion_skin',
    price: 400,
    rarity: 'Rare',
    asset_icon: 'Sparkles',
  ...
  {
    id: 'skin_spriggo_cyber',
    name: 'Neon Cyber Spriggo',
    description: 'High-voltage cyan cybernetic luminescence for Spriggo.',
    type: 'companion_skin',
    price: 750,
    rarity: 'Legendary',
    asset_icon: 'Zap',
